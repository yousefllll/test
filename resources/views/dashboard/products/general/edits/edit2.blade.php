...
<div class="tab-content px-1 pt-1">
                                        <div role="tabpanel" class="tab-pane-avtive" id="tab41" aria-expanded="true" aria-labelledby="base-tab41">
                                            <div class="card-body">
                                                <form class="form" action="{{route('admin.products.update2',$products -> id)}}" method="POST"
                                                      enctype="multipart/form-data">
                                                    @csrf
                                            ...
                                            <a class="nav-link active" id="base-tab41" data-toggle="tab" aria-controls="tab41" href="#tab41" aria-expanded="true">الاسعار</a>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" value="{{$products -> price}}" id="price"
                                                                           class="form-control"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" value="{{$products -> special_price}}" id="special_price"
                                                                           class="form-control"
                                                                           placeholder="ادخل السعر  "
                                                                           name="special_price">
                                                                    @error("special_price")
                                            ...
                                            <form class="form" action="{{route('admin.products.update2',$products -> id)}}" method="POST"
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock" value="1">
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option value="1" selected>اتاحة التتبع</option>
                                                                    <option value="0">عدم اتاحة التتبع</option>
                                                                    @if($products->manageStock == 1) ? selected : 'اتاحة التتبع' }}>متاح @endif />
                                                  ...
                                                  <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($products -> in_stock == 1)checked @endif />
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1">حالة المنتج في المستودع  </label>
