        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{__('admin/sidebar.main Sections')}} </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/sidebar.home')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{__('admin/sidebar.main Sections')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin/setting.all major sections')}} </h4>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('admin/setting.the main section')}} </th>
                                                <th> {{__('admin/setting.name with the link')}} </th>
                                                <th>{{__('admin/setting.status')}}</th>
                                                <th>{{__('admin/setting.section image')}}</th>
                                                <th>{{__('admin/setting.the operations')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            @isset($categories)
                                                @foreach($categories as $category)
                                                    <tr>
                                                        <td>{{$category -> name}}</td>
                                                        <td>{{$category -> _parent -> name  ?? 'dd' }}</td>
                                                        <td>{{$category -> slug}}</td>
