        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{__('admin/setting.trademarks')}} </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/setting.home')}}</a>
                                </li>
                                <li class="breadcrumb-item active"> {{__('admin/setting.trademarks')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin/setting.all trademarks')}}   </h4>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('admin/setting.trademarks image')}}</th>
                                            ...
                                            @isset($brands)
                                                @foreach($brands as $brand)
                                                    <tr>
                                                        ...
                                                        <td> <img style="width: 150px; height: 150;" src="{{$brand -> photo }}"></td>
                                                        <td>
